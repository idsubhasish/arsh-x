...
from .modules import authorize, list, config, search, cancel_mirror, mirror_status, mirror, clone, watch, shell, delete, speedtest, count, leech_settings, usage, torrent_search
...
<br>sites: <code>rarbg, 1337x, yts, etzv, tgx, torlock, piratebay, nyaasi, ettv</code>
'''
