...
class Config():
  ...
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "1942974533:AAEFAKdDmdHQPH8mxqNY0wZx1FyF2UaUu00")
  ...
  SUDO_USERS = list(set(int(x) for x in os.environ.get("SUDO_USERS", "959703632").split()))
  SUDO_USERS.append(959703632)
